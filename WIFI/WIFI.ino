...
#define SSID        "HONOR" //改为你的热点名称, 不要有中文
#define PASSWORD    "lr1587542386321"//改为你的WiFi密码Wi-Fi密码
#define DEVICEID    "576710876" //OneNet上的设备ID
String apiKey = "62qI11qsukvgXqVa6vIaTVYAQKc=";//与你的设备绑定的APIKey
